...
class Kirki_Control_Number extends Kirki_Control_Base {
	...
	public function enqueue() {
		...
		wp_localize_script( 'kirki-script', 'numberKirkiL10n', array(
			'min-error'  => esc_attr__( 'Value lower than allowed minimum', 'june' ),
			'max-error'  => esc_attr__( 'Value higher than allowed maximum', 'june' ),
			'step-error' => esc_attr__( 'Invalid Value', 'june' ),
		) );
	}
