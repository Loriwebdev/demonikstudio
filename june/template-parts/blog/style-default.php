...
<article id="post-<?php the_ID(); ?>" <?php post_class( codeless_extra_classes( 'entry' ) ); ?> <?php echo codeless_extra_attr( 'entry' ) ?>>
	...
	<div class="entry-wrapper">
		...
		<?php endif; ?>
			...
			if( ! codeless_is_single_post() || ( codeless_is_single_post() && codeless_get_post_style() == 'classic' && get_post_type() == 'post' ) || ( codeless_is_single_post() && ! class_exists( 'Cl_Builder_Manager' ) ) ):	
				...
				<header class="entry-header">
					...
					<div class="entry-meta-tools">
						...
						<?php if( ! codeless_is_single_post() || codeless_get_post_style() == 'classic' ): ?>
