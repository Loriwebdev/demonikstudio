...
final class Kirki_Fonts {
	...
	public static function get_google_fonts() {
		...
		if ( null === self::$google_fonts || empty( self::$google_fonts ) ) {
			// codeless
			$fonts = include_once wp_normalize_path( CODELESS_KIRKI_PATH . '/modules/webfonts' . '/webfonts.php' );
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'june' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'june' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'june' ),
			'200'       => esc_attr__( 'Light 200', 'june' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'june' ),
			'300'       => esc_attr__( 'Book 300', 'june' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'june' ),
			'400'       => esc_attr__( 'Normal 400', 'june' ),
			'regular'   => esc_attr__( 'Normal 400', 'june' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'june' ),
			'500'       => esc_attr__( 'Medium 500', 'june' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'june' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'june' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'june' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'june' ),
			'700'       => esc_attr__( 'Bold 700', 'june' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'june' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'june' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'june' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'june' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'june' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'june' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'june' ),
		);
	}
