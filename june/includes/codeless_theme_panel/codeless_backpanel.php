...
private static function let_to_num( $size ) {
    ...
    public static function cl_templates(){
        ...
        $request = wp_remote_get('http://codeless.co/june/register/login.php?check=1&code='.$purchase_code);
    ...
    public static function cl_removeproduct(){
        ...
        $request = wp_remote_get('http://codeless.co/june/register/login.php?remove=1&code='.$purchase_code);
    ...
    public static function cl_version(){
        ...
        $raw_response = wp_remote_get('http://codeless.co/june/register/update.php');
    ...
    */
    ...
    public static function cl_announcements(){
            ...
            $raw_response = wp_remote_get('http://codeless.co/june/register/announcements.php');
    ...
    public static function cl_SystemStatus($json_output = false, $remote_checks = false) {
        ...
        if (!class_exists('Browser') && class_exists('Cl_Builder_Base') ) {
            require_once  get_parent_theme_file_path( '/includes/codeless_theme_panel' ) . '/browser.php';
        }
    ...
    static function get_demos(){
        $demos = array(
            array(
                'id' => 'default',
                'label' => 'Default',
                'preview' => 'http://codeless.co/june/default',
                'parts' => 2
            ),
            array(
                'id' => 'watches',
                'label' => 'Watches',
                'preview' => 'http://codeless.co/june/watches',
                'parts' => 1
            ),
    ...
    static function get_headers(){
        $demos = array(
            ...
            array(
                'id' => 'main2',
                'label' => 'Main with Left Position Nav',
                'preview' => 'http://codeless.co/june/default'
            ),
            array(
                'id' => 'main3',
                'label' => 'Main Search in Extra Row',
                'preview' => 'http://codeless.co/june/default'
            ),
            array(
                'id' => 'main4',
                'label' => 'Main with Shop Menu',
                'preview' => 'http://codeless.co/june/default'
            ),
            array(
                'id' => 'main5',
                'label' => 'Center Menu and Logo',
                'preview' => 'http://codeless.co/june/default'
            ),
            array(
                'id' => 'main6',
                'label' => 'Extra Row Menu Dark',
                'preview' => 'http://codeless.co/june/default'
            ),
            array(
                'id' => 'main7',
            ...
            array(
                'id' => 'main8',
                'label' => 'Shop Menu & Tools',
                'preview' => 'http://codeless.co/june/default'
            ),
            array(
                'id' => 'main9',
                'label' => 'Fullwidth with Shop Menu and Tools',
                'preview' => 'http://codeless.co/june/default'
            ),
            array(
                'id' => 'main10',
                'label' => 'Fullwidth with Tools only',
                'preview' => 'http://codeless.co/june/default'
            ),
            array(
                'id' => 'main11',
                'label' => 'Default with Dark Fullwidth Nav',
                'preview' => 'http://codeless.co/june/default'
            ),
            array(
                'id' => 'main13',
                'label' => 'Menu and Logo Center with Tools',
                'preview' => 'http://codeless.co/june/default'
            ),
            array(
                'id' => 'light_top_nav',
                'label' => 'Light Top navigation',
                'preview' => 'http://codeless.co/june/default'
            ),
            array(
                'id' => 'main12',
                'label' => 'Simple One Row',
                'preview' => 'http://codeless.co/june/default'
            ),  
            array(
                'id' => 'transparent',
