...
<div class="wrapper postbox">
    ...
    <?php } else{ ?>
            ...
            <div class="description">By activate your june WordPress Theme you will able to use any theme feature. You can install demos and activate our plugins.</div>
            ...
            <div class="form">
                ...
                <p>
                    <input id="registerBtn" type="button" class="button-primary  codeless-hint-qtip" value="<?php esc_html_e( 'Register', 'june' ); ?>" />
                </p>
