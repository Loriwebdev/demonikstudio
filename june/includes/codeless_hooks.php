...
// Body Extra Attr
add_filter( 'codeless_extra_attr_body',  'codeless_extra_attr_body' );
...
// Content -> Begin
add_action( 'codeless_hook_content_before', 'codeless_add_post_header', 5 );
...
add_action( 'codeless_hook_content_column_before', 'codeless_leftnav_page_title' );
...
// Top Footer Content:Extra Classes
add_filter( 'codeless_extra_classes_top_footer', 'codeless_extra_classes_top_footer' );

// Top Footer Content:Extra Classes
add_filter( 'codeless_extra_classes_top_footer_content', 'codeless_extra_classes_top_footer_content' );

// Top Footer Content Row:Extra Classes
add_filter( 'codeless_extra_classes_top_footer_content_row', 'codeless_extra_classes_top_footer_content_row' );


// Quick Searches Content:Extra Classes
add_filter( 'codeless_extra_classes_footer_quick_searches_content', 'codeless_extra_classes_footer_quick_searches_content' );

// Quick Searches Content Row:Extra Classes
add_filter( 'codeless_extra_classes_footer_quick_searches_content_row', 'codeless_extra_classes_footer_quick_searches_content_row' );
