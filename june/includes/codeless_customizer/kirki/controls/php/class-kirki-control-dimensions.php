...
class Kirki_Control_Dimensions extends Kirki_Control_Base {
	...
	protected function l10n() {
		return array(
			'left-top'              => esc_attr__( 'Left Top', 'june' ),
			'left-center'           => esc_attr__( 'Left Center', 'june' ),
			'left-bottom'           => esc_attr__( 'Left Bottom', 'june' ),
			'right-top'             => esc_attr__( 'Right Top', 'june' ),
			'right-center'          => esc_attr__( 'Right Center', 'june' ),
			'right-bottom'          => esc_attr__( 'Right Bottom', 'june' ),
			'center-top'            => esc_attr__( 'Center Top', 'june' ),
			'center-center'         => esc_attr__( 'Center Center', 'june' ),
			'center-bottom'         => esc_attr__( 'Center Bottom', 'june' ),
			'font-size'             => esc_attr__( 'Font Size', 'june' ),
			'font-weight'           => esc_attr__( 'Font Weight', 'june' ),
			'line-height'           => esc_attr__( 'Line Height', 'june' ),
			'font-style'            => esc_attr__( 'Font Style', 'june' ),
			'letter-spacing'        => esc_attr__( 'Letter Spacing', 'june' ),
			'word-spacing'          => esc_attr__( 'Word Spacing', 'june' ),
			...
			'size'                  => esc_attr__( 'Size', 'june' ),
			'height'                => esc_attr__( 'Height', 'june' ),
			'spacing'               => esc_attr__( 'Spacing', 'june' ),
			'width'                 => esc_attr__( 'Width', 'june' ),
			'height'                => esc_attr__( 'Height', 'june' ),
			'invalid-value'         => esc_attr__( 'Invalid Value', 'june' ),
		);
	}
}
