...
class Kirki_Init {
	...
	public static function set_url() {
		...
		// Get correct URL and path to wp-content. codeless
	...
	public static function get_variables() {
		...
		_doing_it_wrong( __METHOD__, esc_attr__( 'We detected you\'re using Kirki_Init::get_variables(). Please use Kirki_Util::get_variables() instead.', 'june' ), '3.0.10' );
		// Return result using the Kirki_Util class.
